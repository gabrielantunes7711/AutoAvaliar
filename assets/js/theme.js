...
/* ------- Section Video ------- */
const videoIframe = document.getElementById("iframeHome");
...
if (closeVideoModalBtn && videoModal && videoPlayBtn) {
  videoPlayBtn.addEventListener("click", toggleVideoModal);
  closeVideoModalBtn.addEventListener("click", toggleVideoModal);
  videoModal.addEventListener("click", toggleVideoModal);
}
...
function toggleVideoModal(event) {
  ...
  const srcVideo = videoModal.dataset.iframeSrc;
  ...
  if (videoModal.classList.contains("open")) {
    ...
    videoModal.removeChild(document.querySelector(".container-video iframe"));
  }
}
